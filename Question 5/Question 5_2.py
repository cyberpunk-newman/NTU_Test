...
def buildmap(N):
    ...
    with open('C:/Users/RM.Z/Desktop/SO金牌/NTU/Question 5/map.txt',"a") as f:
    ...
    for i in range(1,N**2+1):
        ...
        if (i%N == 0):
            ...
            with open('C:/Users/RM.Z/Desktop/SO金牌/NTU/Question 5/map.txt',"a") as f:
                text=f.write(str(str0)+"\n")
            f.close()
            #np.savetxt('C:/Users/RM.Z/Desktop/SO金牌/NTU/Question 5/input.txt',arr)
            edge += 1
            #print('1',edge)
...
# buildmap(L)
buildmap(64)
edge, pointNum = getAdjMatrix(r'C:/Users/RM.Z/Desktop/SO金牌/NTU/Question 5/map.txt')
print('')
#     for i in edge:
#         print('    ', end='')
#         for j in i:
